...
//
//           if (success) {
//             // Determine the image path for local storage
//             String? imagePath = _entity!.image;
//             if (_imageFile != null) {
...
//           );
//
//           // Save to local database with the image path
//           final newEntity = Entity(
//             id: entityId,
//             title: _titleController.text,
//             lat: double.parse(_latController.text),
//             lon: double.parse(_lonController.text),
//             image: "images/image_${DateTime.now().millisecondsSinceEpoch}.jpg", // Store server path format
//           );
//
//           await _dbHelper.insertEntity(newEntity);
//
...
//                               imageUrl: _entity!.image!.startsWith('http')
//                                   ? _entity!.image!
//                                   : 'https://labs.anontech.info/cse489/t3/${_entity!.image}',
//                               fit: BoxFit.cover,
//                               width: double.infinity,
